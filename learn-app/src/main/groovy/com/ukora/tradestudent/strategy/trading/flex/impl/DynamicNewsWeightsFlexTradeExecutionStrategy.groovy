...
@Component
class DynamicNewsWeightsFlexTradeExecutionStrategy implements FlexTradeExecutionStrategy {
    ...
    TradeExecution getTrade(
        ...
        Double buyProbability = textCorrelationAssociation.strategyProbabilities?.get(COMBINER_STRATEGY)?.NEWS?.get(buyTag.tagName)
        Double upProbability = textCorrelationAssociation.strategyProbabilities?.get(COMBINER_STRATEGY)?.NEWS?.get(upTag.tagName)
        Double upReversalProbability = textCorrelationAssociation.strategyProbabilities?.get(COMBINER_STRATEGY)?.NEWS?.get(upReversalTag.tagName)
        Double upMoveProbability = textCorrelationAssociation.strategyProbabilities?.get(COMBINER_STRATEGY)?.NEWS?.get(upMoveTag.tagName)
