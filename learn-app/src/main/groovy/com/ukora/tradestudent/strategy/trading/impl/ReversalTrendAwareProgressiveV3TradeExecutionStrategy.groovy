 ...
 *
 * This version uses a different reversal weight - and a higher trend division factor and
 * a more aggressive progressive factor
 */
@Component
class ReversalTrendAwareProgressiveV3TradeExecutionStrategy  implements TradeExecutionStrategy, TagSubset {

    /**
     * Implementation specific settings
     */
    private final Double TREND_REVERSAL_DIVISION_FACTOR = 4
    private final Double TREND_WEIGHT = 1
    private final Double REVERSAL_WEIGHT = 3

    /**
     * Progressive trading settings
     */
    final static Double MAX_MULTIPLIER = 8
