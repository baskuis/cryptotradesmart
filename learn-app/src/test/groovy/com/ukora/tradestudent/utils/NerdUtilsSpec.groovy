...
class NerdUtilsSpec extends Specification {
    ...
    def "Applying new value[#value], mean[#mean], count[#count] gets correct new standard deviation #expectedValue"() {
        ...
        when:
        def d = NerdUtils.applyValueGetNewDeviationAlt(
                value as Double,
                mean as Double,
                count as Double,
                deviation as Double)
        ...
        1                       | 1                      | 1            | 0            | 0
        3                       | 1                      | 5            | 1            | 1.1785113019775793
        1                       | 2                      | 2            | 1            | 0.9428090415820634
        1                       | 2                      | 3            | 1            | 0.9682458365518543
        1                       | 2                      | 4 as Double  | 1            | 0.9797958971132712
        1                       | 2                      | 5            | 1            | 0.9860132971832694
        1                       | 1                      | 2            | 1            | 0.816496580927726
        1.1                     | 1.2                    | 3 as Integer | 0.879        | 0.762466884526797
        343.5625743637561       | 0.0                    | 1.0          | 0.0          | 171.78128718187804
        343.5625743637561       | 0.0                    | 10.0         | 0.0          | 98.76729579822214
        0.002410952215149232555 | 0.00241095221514986515 | 100          | 0.0          | 6.259238572904624E-17
        0.002410952215149232555 | 1.00241095221514986515 | 2 + 1        | 0.0          | 0.43301270189221963
        8.41204417455325E-5     | 8.412044174553253E-5   | 73           | 0.0          | 3.150898561808974E-21
        49.940083692540036      | 49.94008369254003      | 58           | 0.0          | 0
        4                       | 1.8                    | 5            | 0.7483314774 | 1.0671873729318941
        600                     | 141.962963             | 27           | 392.9374167  | 395.10848903925165
    ...
    def "Applying new value gets new mean #expectedValue"() {
        ...
        4            | 2.6                | 5     | 2.8333333333333335
        2000         | 2.8333333333333335 | 6     | 288.14285714285717
