...
@Component
class GdaxTradePlatform implements TradePlatform {

    Map<CurrencyPair, Exchange> exchangeLookup = [:]

    final private String URL_GET_ORDER_BOOK = 'https://api.gdax.com/products/%s/book?level=3'
