...
class ReversalTrendAwareProgressiveTradeExecutionStrategySpec extends Specification {

    TradeExecutionStrategy tradeExecutionStrategy

    def setup() {
        tradeExecutionStrategy = new ReversalTrendAwareProgressiveTradeExecutionStrategy(
                upTag: new UpTag(),
                downTag: new DownTag(),
                buyTag: new BuyTag(),
                sellTag: new SellTag(),
